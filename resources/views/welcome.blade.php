                    ...
                    <div class="row">
                        <div class="col-lg-6 col-12">
                            <div class="table-pricing paket-gila">
                                ...
                                <p>
                                    <a href="{{route('checkout.create', 'menjadi-fullstack-developer')}}" class="btn btn-master btn-primary w-100 mt-3">
                                        Take This Plan
                                    </a>
                                </p>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-12">
                            <div class="item-review">
                                ...
                                <div class="user">
                                    <img src="{{asset('images/member-1.png')}}" class="photo" alt="">
                                    <div class="info">
                                        <h4 class="name">
                                            Abdullah
                                        </h4>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="item-review">
                                ...
                                <div class="user">
                                    <img src="{{asset('images/member-2.png')}}" class="photo" alt="">
                                    <div class="info">
                                        <h4 class="name">
                                            Abdurahman
                                        </h4>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="item-review">
                                ...
                                <div class="user">
                                    <img src="{{asset('images/member-3.png')}}" class="photo" alt="">
                                    <div class="info">
                                        <h4 class="name">
                                            Yusuf
                                        </h4>
